...
if ( !class_exists( 'tek_clients' ) ) {
    class tek_clients extends KEYDESIGN_ADDON_CLASS {
                ...
                vc_map( array(
                    ...
                    "params" => array(
                        ...
                        array(
                            "type"          =>  "dropdown",
                            "class"         =>  "",
                            "heading"       =>  esc_html__("Navigation speed","keydesign"),
                            "param_name"    =>  "client_navigation_speed",
                            "value"         =>  array(
                                "Default"   => "default-nav-speed",
                                "0.1s"   => "100",
                                "0.2s"   => "200",
                                "0.3s"   => "300",
                                "0.4s"   => "400",
                            ...
                            "description"   =>  esc_html__("Select navigation speed. The default speed is set to 0.3s.", "keydesign")
                        ),
                        ...
                        array(
                            "type"          =>  "dropdown",
                            "class"         =>  "",
                            "heading"       =>  esc_html__( "Direction", "keydesign" ),
                            "param_name"    =>  "carousel_direction",
                            "value" => array(
                                esc_html__( "Left to right", "keydesign" ) => "carousel-ltr",
                                esc_html__( "Right to left", "keydesign" ) => "carousel-rtl",
                            ),
                            "save_always" => true,
                            "description" => esc_html__( "Choose carousel slide direction.", "keydesign" ),
                        ),
        ...
        public function kd_clients_container( $atts, $content = null ) {
            ...
            // Navigation speed
            if ( $client_navigation_speed == 'default-nav-speed' || $client_navigation_speed == '' ) {
              $client_navigation_speed = 300;
            }
              ...
              jQuery(document).ready(function($){
                if ($(".slider.clients.'.$kd_clientunique_id.'").length) {
                  $(".slider.clients.'.$kd_clientunique_id.'").owlCarousel({
                      ...
                      960:{
                          ...
                          if ( $client_nav == 'nav-enable' && ! vc_is_inline() ) {
                            if( $client_nav_style == "nav-dots" ) {
                              $output .='dots: true,
                              nav: false,
                              dotsSpeed: '.$client_navigation_speed.',
                              dotsEach: false,';
                            } elseif ( $client_nav_style == "nav-arrows-dots" ) {
                              $output .= 'nav: true,
                              navSpeed: '.$client_navigation_speed.',
                              dots: true,
                              dotsSpeed: '.$client_navigation_speed.',
                              dotsEach: false,';
                            } else {
                    ...
                    if ( $carousel_direction == 'carousel-rtl' ) {
                        $output .= 'rtl: true,';
                    }
