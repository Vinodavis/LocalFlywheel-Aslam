...
class KeyDesign_Vc_Templates_Panel_Editor {
	...
	public function swayTemplates( $data ) {
				$TemplatesCategory = array(
					'category'        => 'keydesign_templates',
					'category_name'   => esc_html__( 'Sway Blocks', 'keydesign' ),
					'category_weight' => 1,
	...
	public function filters_list() {
			...
			$output .= '<li class="filter active" id="all">All<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="InnerPages">Pages <span class="badge-new">Full Pages</span><span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="IntroSections">Intro <span class="badge-new">New</span><span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Sliders">Slider <span class="badge-new">New</span><span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Contentblocks">Creative <span class="badge-new">New</span><span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="StickyNavbar">Sticky Navbar<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="BlogPosts">Blog<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Cta">CTA<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Cards">Cards<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Charts">Charts<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Counters">Counters<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Faq">FAQ<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="ContactForms">Forms<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Gallery">Gallery<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="IconBoxes">Icon Box<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Logos">Logos<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Maps">Map<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Processes">Process<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Pricing">Pricing</span><span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Portfolio">Portfolio<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Reviews">Reviews<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Sidebar">Sidebar<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Shop">Shop<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Tabs">Tabs<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Team">Team<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Testimonials">Testimonials<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="TextBlocks">Text<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Timeline">Timeline <span class="badge-new">New</span><span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="TitleBlocks">Title<span class="block-counter"></span></li>';
				$output .= '<li class="filter" id="Video">Video<span class="block-counter"></span></li>';
			$output .= '</ul>';
			return $output;	}
