...
function keydesign_page_metaboxes() {
	...
	$box_options = apply_filters(
		'keydesign_page_metabox_options',
		array(
	...
	$tabs_setting['tabs'][] = array(
		...
		'fields' => array(
			...
			array(
				'name' => esc_html__( 'Transparent logo image', 'keydesign' ),
				'desc' => 'Select logo image for the transparent header bar.',
				'id' => 'keydesign_transparent_logo_image',
				'type' => 'radio_inline',
				'options' => array(
					'default' => esc_html__( 'Default', 'keydesign' ),
					'primary-logo' => esc_html__( 'Primary logo', 'keydesign' ),
					'secondary-logo' => esc_html__( 'Secondary logo', 'keydesign' ),
				),
				'default' => 'default',
			),
		)
