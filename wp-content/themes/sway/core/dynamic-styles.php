...
$transparent_navigation_color = get_post_meta( $post_id, 'keydesign_transparent_menu_color', true );
?>
...
<?php if ( class_exists( 'WooCommerce' ) ) : ?>
	...
	<?php if ( sway_get_option( 'tek-woo-single-titlebar-color' ) ) : ?>
		.woocommerce-page.single-product .blog-header.entry-header {
			background-color: <?php echo esc_attr( sway_get_option( 'tek-woo-single-titlebar-color' ) ); ?>;
		}
	<?php endif; ?>
<?php endif; ?>
...
.pricing.active,
#user-submit, #bbp_search_submit, .bbp-submit-wrapper .button,
.vc_grid-item-mini .vc_gitem-zone .vc_btn3.vc_btn3-style-custom,
.primary-button.button-inverse:hover,
.primary-button.button-inverse,
.wpcf7 .wpcf7-submit,
...
.lower-footer a {
	...
	<?php if ( isset( $footer_typo['font-family'] ) && '' != $footer_typo['font-family'] ): ?>
		font-family: <?php echo stripslashes( $footer_typo['font-family'] ); ?>;
	<?php endif; ?>
...
<?php  if ( sway_get_option( 'tek-default-typo' ) ) : ?>
	body,.key-icon-box a p, .box, .cb-text-area p, body p , .upper-footer .search-form .search-field, .upper-footer select, .footer_widget .wpml-ls-legacy-dropdown a, .footer_widget .wpml-ls-legacy-dropdown-click a {
		...
		<?php if ( isset( $default_typo['font-family'] ) && '' != $default_typo['font-family'] ): ?>
			font-family: <?php echo stripslashes( $default_typo['font-family'] ); ?>;
		<?php endif; ?>
...
.container #logo .logo {
	...
	<?php if ( isset( $text_logo_typo['font-family'] ) && '' != $text_logo_typo['font-family'] ): ?>
		font-family: <?php echo stripslashes( $text_logo_typo['font-family'] ); ?>;
	<?php endif; ?>
...
<?php  if ( sway_get_option( 'tek-h1-heading' ) ) : ?>
	.container h1 {
		...
		<?php if ( isset( $h1_heading['font-family'] ) && '' != $h1_heading['font-family'] ): ?>
			font-family: <?php echo stripslashes( $h1_heading['font-family'] ); ?>;
		<?php endif; ?>
...
<?php  if ( sway_get_option( 'tek-h2-heading' ) ) : ?>
	.container h2, #popup-modal .modal-content h2 {
		...
		<?php if ( isset( $h2_heading['font-family'] ) && '' != $h2_heading['font-family'] ): ?>
			font-family: <?php echo stripslashes( $h2_heading['font-family'] ); ?>;
		<?php endif; ?>
...
<?php  if ( sway_get_option( 'tek-h3-heading' ) ) : ?>
	.container h3, .kd-panel-header .kd-panel-title {
		...
		<?php if ( isset( $h3_heading['font-family'] ) && '' != $h3_heading['font-family'] ): ?>
			font-family: <?php echo stripslashes( $h3_heading['font-family'] ); ?>;
		<?php endif; ?>
...
<?php  if ( sway_get_option( 'tek-h4-heading' ) ) : ?>
	...
	.container h4, .kd-photobox .phb-content h4, .content-area .vc_grid-item-mini .vc_gitem_row .vc_gitem-col h4 {
		...
		<?php if ( isset( $h4_heading['font-family'] ) && '' != $h4_heading['font-family'] ): ?>
			font-family: <?php echo stripslashes( $h4_heading['font-family'] ); ?>;
		<?php endif; ?>
...
<?php  if ( sway_get_option( 'tek-h5-heading' ) ) : ?>
	...
	.container h5 {
		...
		<?php if ( isset( $h5_heading['font-family'] ) && '' != $h5_heading['font-family'] ): ?>
			font-family: <?php echo stripslashes( $h5_heading['font-family'] ); ?>;
		<?php endif; ?>
...
<?php  if ( sway_get_option( 'tek-h6-heading' ) ) : ?>
	.container h6, .key-icon-box h6.service-heading {
		...
		<?php if ( isset( $h6_heading['font-family'] ) && '' != $h6_heading['font-family'] ): ?>
			font-family: <?php echo stripslashes( $h6_heading['font-family'] ); ?>;
		<?php endif; ?>
...
<?php  if ( sway_get_option( 'tek-menu-typo' ) ) : ?>
	...
	body .navbar-default .nav li a, body .modal-menu-item {
		...
		<?php if ( isset( $menu_typo['font-family'] ) && '' != $menu_typo['font-family'] ): ?>
			font-family: <?php echo stripslashes( $menu_typo['font-family'] ); ?>;
		<?php endif; ?>
...
<?php if ( sway_get_option( 'tek-typekit-switch' ) && '' != sway_get_option( 'tek-typekit' ) ) : ?>
...
.hover_outline_primary:hover {
   ...
   color: <?php if ( sway_get_option( 'tek-main-color' ) ) { echo esc_attr( sway_get_option( 'tek-main-color' ) ); } ?> !important;
...
<?php if ( sway_get_option( 'tek-button-typo') ) : ?>
	...
	.single-page-content .tt_button, .tt_button, .wpcf7 .wpcf7-submit,  .content-area .vc_grid .vc_gitem-zone-c .vc_general, .tt_button.modal-menu-item, .vc_grid-item-mini .blog-detailed-grid .vc_btn3-container a,
	...
	.pricing-table .tt_button, .pricing-table.active .tt_button {
		...
		<?php if ( isset( $button_typo['font-family'] ) && '' != $button_typo['font-family'] ): ?>
			font-family: <?php echo stripslashes( $button_typo['font-family'] ); ?>;
		<?php endif; ?>
...
<?php if ( sway_get_option( 'tek-logo-spacing') ) : ?>
	@media (min-width:1270px) {
		...
		#logo .logo img {
		<?php if ( sway_get_option( 'tek-logo-image-height' ) ) : ?>
			height: <?php echo esc_attr( sway_get_option( 'tek-logo-image-height' ) ) ?>px;
		<?php endif; ?>
		}
	}
<?php endif; ?>
...
@media (max-width: 960px) {
	...
	#logo .logo img {
			...
			<?php endif; ?>
			<?php if ( sway_get_option( 'tek-mobile-logo-image-height' ) ) : ?>
			height: <?php echo esc_attr( sway_get_option( 'tek-mobile-logo-image-height' ) ) ?>px;
			max-height: <?php echo esc_attr( sway_get_option( 'tek-mobile-logo-image-height' ) ) ?>px;
			<?php endif; ?>
	}
