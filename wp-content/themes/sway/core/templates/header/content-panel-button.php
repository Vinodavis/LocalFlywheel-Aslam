...
if ( sway_get_option( 'tek-panel-button-css-class' ) ) {
    $button_extra_class = sway_get_option( 'tek-panel-button-css-class' );
}
...
<?php if ( sway_get_option( 'tek-panel-button' ) &&  sway_get_option( 'tek-panel-button-action' ) == '1' ) : ?>
   <button class="<?php echo esc_attr($btn_wrapper_class); ?> panel-trigger-btn" aria-label="<?php echo esc_html( sway_get_option( 'tek-panel-button-text' ) ); ?>"><?php echo esc_html( sway_get_option( 'tek-panel-button-text' ) ); ?></button>
